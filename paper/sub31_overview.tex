...
The computational evidence is strong: no sub-31 KS set has been found by any of seven independent methods, and the realizability barrier (Observation~\ref{obs:barrier}) shows that abstract sub-31 KS hypergraphs are combinatorially plentiful but have resisted all attempts at geometric realization. We frame the following as structural insights and candidate proof directions, not as partial proofs.
