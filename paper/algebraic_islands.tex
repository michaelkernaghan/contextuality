...
\textbf{Case 1: $3 \nmid n$, $2 \nmid n$.}  No vanishing sums of any length exist among the $n$th roots, so the only orthogonalities are axis-complementary (complementary zero patterns).  The sole triad is $\{[1{:}0{:}0],\, [0{:}1{:}0],\, [0{:}0{:}1]\}$, and the pool is trivially colorable.
